...
module.exports = "<p>\n  {{ greeting }}\n</p>\n\n<div class=\"bottom-wrapper\">\n    <div class=\"centered-container\">\n        <form>\n          <div class=\"input-container\">\n            <label for=\"password\">E-MAIL</label>\n            <div class=\"centered-container\">\n                <input autofocus [ngClass]=\"{ 'stgc-input': true, 'invalid': !isValid }\" type=\"email\" [ngModel]=\"email\" (ngModelChange)=\"emailChanged($event)\" name=\"email-input\" label=\"E-MAIL\"/>\n              </div>\n          </div>\n          <app-stgc-button route=\"/setup\" text=\"SUBMIT\" [disabled]=\"!isValid\"></app-stgc-button>\n        </form>\n      </div>\n      \n</div>"
...
var PasswordResetComponent = (function () {
    ...
    PasswordResetComponent.prototype.emailChanged = function (value) {
...
module.exports = "{{ greeting }}\n<div class=\"bottom-wrapper\">\n    <div class=\"centered-container\">\n        <b>{{error}}</b>\n        <form>\n          <div class=\"input-container\">\n            <label for=\"password\">NEW PASSWORD</label>\n            <input autofocus [ngClass]=\"{ 'stgc-input': true, 'invalid': !isValid }\" name=\"password\" [ngModel]=\"newPassword\" (ngModelChange)=\"onPassword1Change($event)\" type=\"password\"\n            />\n          </div>\n          <br/>\n          <div class=\"input-container\">\n            <label for=\"repeated-password\">REPEAT NEW PASSWORD</label>\n            <input [ngClass]=\"{ 'stgc-input': true, 'invalid': !isValid }\" name=\"repeated-password\" [ngModel]=\"repeatedPassword\" (ngModelChange)=\"onPassword2Change($event)\"\n              type=\"password\" />\n          </div>\n          <br/>\n          \n          <app-stgc-button [disabled]=\"!isValid\" route=\"/success\" text=\"SUBMIT\"></app-stgc-button>\n        </form>\n      </div>\n      \n</div>\n"
...
var PasswordSetupComponent = (function () {
    ...
    PasswordSetupComponent.prototype.onPassword1Change = function (value) {
        this.password1 = value;
        this.validatePasswords();
    };
    PasswordSetupComponent.prototype.onPassword2Change = function (value) {
